													...
													"<div class='d-flex experiences-inner-card-btn-panel'>"+
														"<ul class='experiences-inner-card-btn-item'>"+
												        	"<li class='experiences-inner-card-btn-panel-icon'>"+
																"<img src='https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/DocumentsForAll/assets/images/checkmark.png'>"+
															"</li>"+
															"<li class='experiences-inner-card-btn-panel-count' onclick='' id='"+AcknowledgeId+"'>"+FilteredRecAcknowledgeCount+"</li>"+
												        	"<li class='experiences-inner-card-btn-panel-icon'>"+
																"<img src='https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/DocumentsForAll/assets/images/visibility-icon.png'>"+
															"</li>"+
															"<li class='experiences-inner-card-btn-panel-count'>"+FilteredRecViewCount+"</li>"+
															"<li class='experiences-inner-card-btn-panel-icon'>"+
																"<img src='https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/DocumentsForAll/assets/images/like-icon.png'>"+
															"</li>"+
...
function ListofActiveusers(PassingValue)
{
    ...
    if(FilterResultQuery.length>0)
    {
		...
		{
			var UserImage = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + ActionBy[i].Author.EMail//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
...
{
	res = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/file.png';
	switch(tempval)
	{
		case 'docx':	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/doc.png'; break;
	    case 'pdf': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/pdf.png'; break;
	 	case 'xlsx':	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/xls.png'; break;
	 	case 'xls': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/xls.png'; break;
	 	case 'doc': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/doc.png'; break;	 	
	 	case 'html': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/html.png'; break;	 	
	 	case 'js': 		tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/javascript.png'; break;	 	
	 	case 'jpg': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/jpg.png'; break;	 	
	 	case 'ppt': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/ppt.png'; break;	 	
	 	case 'png': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/png.png'; break;	 	 	
	 	case 'mp3': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/mp3.png'; break;
	 	case 'mp4': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/mp4.png'; break;
	 	case 'avi': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/avi.png'; break;
	 	case 'csv': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/csv.png'; break;
	 	case 'wmv': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/wmv.png'; break;
	 	case 'jpeg':	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/jpeg.png'; break;
	 	case 'bmp': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/bmp.png'; break;
	 	case 'gif': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/gif.png'; break;
	 	case 'txt': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/txt.png'; break;
	 	case 'zip': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/zip.png'; break;
	 	case 'css': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/css.png'; break;
	 	case 'ppt': 	tempval  = 'https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/ContactCenter/assets/ExtensionImages/ppt.png'; break;
