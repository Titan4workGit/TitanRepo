        ...
        success: function (data) 
        {
            ...
            else 
            {
            	...
            	for(var i=0; i<ApprovalTaskListUsageData.length; i++)
            	{
					...
					var StatusImg = '';
						if(ApprovalTaskListUsageData[i].Status == "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
						else if(ApprovalTaskListUsageData[i].Status == "Initiated"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
						else if(ApprovalTaskListUsageData[i].Status == "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
						else if(ApprovalTaskListUsageData[i].Status== "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
					var ActionByDisplay = '';
        ...
        success: function (data) 
        {
            ...
            {	executionSequence = executionSequence + 1;	
            	for(var i=0; i<ApprovalProcessListUsageData.length; i++)
            	{
					...
					var StatusImg = '';
						if(ApprovalProcessListUsageData[i].Status == "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
						else if(ApprovalProcessListUsageData[i].Status == "Initiated" || ApprovalProcessListUsageData[i].Status == 'Pending'){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
						else if(ApprovalProcessListUsageData[i].Status == "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
						else if(ApprovalProcessListUsageData[i].Status == "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
					var ActionByDisplay = '';
					...
					{
						PriorityImg = 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rd_icon.png';
					}
        ...
        success: function (data) 
        {
            ...
            {	executionSequence = executionSequence + 1;	
            	for(var i=0; i<DocumentApprovalRequestsUsageData.length; i++)
            	{
					...
					var StatusImg = '';
						if(DocumentApprovalRequestsUsageData[i].Status== "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
						else if(DocumentApprovalRequestsUsageData[i].Status== "Initiated" || DocumentApprovalRequestsUsageData[i].Status == 'Pending'){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
						else if(DocumentApprovalRequestsUsageData[i].Status== "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
						else if(DocumentApprovalRequestsUsageData[i].Status== "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
					var ActionByDisplay = '';
...
function ActionTaken(Action,PassingValues)
{
	...
	if(Action.dataset.target == "#contentsApprovalAction")
	{
    	...
    	{
    		var StatusImg = '';
				if(QueryResult[0].Status== "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
				else if(QueryResult[0].Status== "Initiated" || QueryResult[0].Status == 'Pending'){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
				else if(QueryResult[0].Status== "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
				else if(QueryResult[0].Status== "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
        ...
        else if(Action.hreflang.split(',')[0] == 'ApprovalProcessList')
		{
    		...
    		if(QueryResult.length>0)
    		{
    	    	...
    	    	if(ExecutionStatus == true)
    	    	{
					...
					$('#CurrentStepStatusImgProcessApproval').attr('src', 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png');
    				...
    				if(QueryResult.length>0)
    				{
    					...
    					var StatusImg = 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png';						
...
function GetDigitalSignatures()
{
	...
	if(ResultProcessSignatureSetup.length>0)
	{
		...
		{
			var StatusImg = '';
				if(FilteredRec[0].Status== "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
				else if(FilteredRec[0].Status== "Initiated" || FilteredRec[0].Status == 'Pending'){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
				else if(FilteredRec[0].Status== "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
				else if(FilteredRec[0].Status== "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
	...
	if(QueryResult.length>0)
	{
		...
		{	
			...
			HistoryDesign = HistoryDesign + "<li>"+
											"<span class='iconbox'>"+
												"<img src='https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/time-icon-1.png' alt=''>"+
    										"</span>"+
		...
		for(var i=0; i<QueryResult.length; i++)
		{
			if(QueryResult[i].ActionTakenbyId != null)
			{
				...
				var StatusImg = '';
						if(QueryResult[i].Status== "Rejected"){StatusImg = "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/rejected-img.png";}
						else if(QueryResult[i].Status== "Initiated" || QueryResult[i].Status == 'Pending'){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/initiated-img.png";}
						else if(QueryResult[i].Status== "Approved"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/approved-img.png";}
						else if(QueryResult[i].Status== "Forwarded"){StatusImg ="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Approvals/assets/images/forwarded-img.png";}
