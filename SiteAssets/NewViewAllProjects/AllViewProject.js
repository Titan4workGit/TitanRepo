        ...
        success: function (data) {
             ...
             for(var i=0; i<response.length;i++){
               ...
               if(ProjectCode==null){               
                ...
                var employeePicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(ManagerEMail)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/QuestionAnswer/images/user_pic.jpg";
