        ...
        success: function (data) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (items[i].AttachmentFiles.results.length > 0) {
                    ...
                    employeePicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[i].LogonName.EMail)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                }
        ...
        success: function (data) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (items[i].AttachmentFiles.results.length > 0) {
                    ...
                    {
                        //employeePicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[i].Email)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
...
function SetVisibility(text)
{
    ...
    {
        $('#profile-image1').attr("src","https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg");
        $("#InternalUsersDiv").css("display", "none");
        $("#ExternalUsersDiv").css("display", "block");
...
function GetEmployeeDTL(EmpID) {
    ...
    $.ajax({
        ...
        success: function (data) 
        {
            ...
            {
            	EmpProfileImage = "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
            }
