...
var FilesArr=new Array();
	...
	$(".like-img").click(function () {
		...
		var newsrc = (src == 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/like-icon.png') ? 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/like-icon-fill.png' : 'https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/like-icon.png';
	});
    ...
    $.ajax({
        ...
        success: function (data)
        {
               ...
               if(ImageCount!=0){
	            ...
	            if(thumbNailUrl=="")
	            {
                  thumbNailUrl="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MediaGallery/assets/images/album-icon.png";
...
function GetDataforModel(RecId)
{
	...
	$.ajax({
    	...
    	{          	   
			...
			var AuthImage = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + data.d.results[0].Author.EMail//"https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                //AuthPhoto	
    ...
    $.ajax({  
        ...
        success: function (data){ 
			...
			{  
				...
				var AuthImage = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + items[0].LogonName.EMail//"https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                //AuthPhoto	
                $('#AuthPhoto').attr('src', AuthImage);
...
{	
    ...
    if($(".like-img").attr("src") == "https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/like-icon.png"){
	                    								...
	                    								"<h4 class='col-md-12 col-sm-12 my-chat-edit-delete-panel'>"+
	                      									"<div>"+
	                        									"<div id='editMenuOpen2' class='chat-edit-delete-panel dropdown-toggle' data-toggle='dropdown' aria-expanded='false'>"+
	                          										"<img src='https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/more-horiz.png' alt='more horiz' data-themekey='#'>"+
	                        									"</div>"+
                ...
                Commenthtmldesign = Commenthtmldesign + "<div class='col-md-12 col-sm-12 reply-box-ext'>"+
		                    								...
		                    								"<h4 class='col-md-12 col-sm-12 my-chat-edit-delete-panel'>"+
		                      									"<div class='reply-text-line'><a href='javascript:void(0);' class='comment-reply-user-name-info'>@<span >"+AnnResponse[i].ReplyTo+"</span> :</a><span class='replymsgAnn'>"+AnnResponse[i].ReplyAgainst+"</span>"+
		                      										"<div class='chat-edit-delete-panel dropdown-toggle' data-toggle='dropdown' aria-expanded='false'>"+
		                          										"<img src='https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/Biography/Experience/assets/images/more-horiz.png' alt='more horiz'>"+
		                        									"</div>"+
		                        									"<ul class='dropdown-menu dropdown-menu-right chat-edit-delete-dropdown'>"+
    ...
    {	var RecId= AttachmnetIDs[k];
        ...
        for(var p=0; p<FilterResult.length; p++)
        {
            if(FilterResult[p].FileName.indexOf("docx") != -1){
                ...
                Attachmentdesign = Attachmentdesign + "<div class='m-0  upload-chip chatAttach_Others'> <span class='pr-8 chip-text-box'><img src='https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/CompanyHomePage/Sliders/Image/File_Icon/file.png'></img><a name='" +FilterResult[p].ServerRelativeUrl+ "' onclick='previewfile(this);' href='javascript:void(0)'>"+FilterResult[p].FileName+"</a></span> <span class='chip-icon-box'> <a href='" +FilterResult[p].ServerRelativeUrl+ "' download><i class='fa fa-download cursor-pointer px-4' aria-hidden='true'></i></a></span> </div>";		
            }
        }
