   ...
   var redirecturl='../Pages/MediaGalleryDetail.aspx?WebAppId=2&FName='+targetfolderUrl+'&Mode=View&sourcelocation=../Pages/MediaGalleryNew.aspx';
      ...
      var menuFolderHTML=''
             if(ImageCount==0){
                ...
                menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/default album.png" alt="album img grid default"></div></div>'                                 
                ...
                menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/image-gallery-icon.jpg" data-themekey="#">'
                menuFolderHTML +='</div>'
                ...
                menuFolderHTML +='<div class="album-inner-card-btn-panel-icon">'
                menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/visibility-icon.png" data-themekey="#">'
                menuFolderHTML +='</div>'
                ...
                menuFolderHTML +='</div>'
                menuFolderHTML +='<div class="album-inner-card-btn-panel-icon">'
                menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/like-icon.png" data-themekey="#">'
                menuFolderHTML +='</div>'
                menuFolderHTML +='<div class="album-inner-card-btn-panel-count">1</div>'
                menuFolderHTML +='<div class="album-inner-card-btn-panel-gap"><span> </span>'
                menuFolderHTML +='</div>'
                menuFolderHTML +='<div class="album-inner-card-btn-panel-icon">'
                menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/chat-icon.png" data-themekey="#">'
                menuFolderHTML +='</div>'
              ...
              if(ImageCount==2){
				...
				//menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/album-bg-1.jpg" alt="album img grid default">'
				menuFolderHTML +='</div>'
				...
				//menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/album-bg-2.jpg" alt="album img grid default">'
				menuFolderHTML +='</div></div></div>'
				menuFolderHTML +='<div class="col-xs-12 col-sm-9 album-card-right">'
				menuFolderHTML +='<div class="album-detail-box">'
				menuFolderHTML +='<div class="album-heading">'
              ...
              menuFolderHTML +='<div class="col-xs-12 col-sm-12 album-col-info album-card">'
				...
				//menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/album-bg-3.jpg" alt="album img grid default">'
				menuFolderHTML +='</div></div></div></div>'
				menuFolderHTML +='<div class="col-xs-12 col-sm-9 album-card-right">'
				menuFolderHTML +='<div class="album-detail-box">'
				menuFolderHTML +='<div class="album-heading">'
              ...
              if(ImageCount>=4){
               menuFolderHTML +='<div class="col-xs-12 col-sm-12 album-col-info album-card">'
				...
				//menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/album-bg-4.jpg" alt="album img grid default">'
				menuFolderHTML +='</div></div></div></div>'
				menuFolderHTML +='<div class="col-xs-12 col-sm-9 album-card-right">'
				menuFolderHTML +='<div class="album-detail-box">'
				menuFolderHTML +='<div class="album-heading">'
