...
function BindApprovalHistory() {
    ...
    $.when(getItemsWithQuery("DocumentApprovalRequests", Query)).done(function (valuesArray) {
        ...
        AppHistory += '<li><span class="iconbox"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-1.png" alt=""></span>';
    ...
    $.when(getItemsWithQuery("DocumentApprovalQueue", Query)).done(function (valuesArray) {
        ...
        for (var step = 0; step < valuesArray.length; step++) {
            if (valuesArray[step].Status == "Started") {
                AppHistory += '<li id="DocQueue' + valuesArray[step].Sequence_No + '"><span class="iconbox"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-3.png" alt=""></span>';
                AppHistory += '<div class="dropdown"><button class="dropdown-toggle" type="button" style="display:' + Visibility + '" data-toggle="dropdown">';
                AppHistory += '<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/dotting.png" alt=""></button><ul class="dropdown-menu pull-right">';
                ...
                arrayCopy = valuesArray.filter(function (f) { return f; });
                AppHistory += '<li id="DocQueue' + valuesArray[step].Sequence_No + '"><span class="iconbox"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-2.png" alt=""></span>';
                ...
                AppHistory += '<li id="DocQueue' + valuesArray[step].Sequence_No + '"><span class="iconbox"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-4.png" alt=""></span>';
                ...
                AppHistory += '<li id="DocQueue' + valuesArray[step].Sequence_No + '"><span class="iconbox"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-5.png" alt=""></span>';
                AppHistory += '<div class="approvelheadeing"><h3 class="mainheading">' + valuesArray[step].StepName + '</h3><span class="date-sec">' + moment(valuesArray[step].Modified).format('DD-MMM-YYYY hh:mm A') + '<p> ' + (valuesArray[step].ActionByTimeZone ? valuesArray[step].ActionByTimeZone : "") + '</p></span>';
