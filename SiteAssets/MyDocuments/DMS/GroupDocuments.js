    ...
    $.when(getItemsWithQuery("PersonalDMS_Setting", restQueryPersonalDMS, _spPageContextInfo.webAbsoluteUrl)).done(function(PersonalDMSData) {
        ...
        if (PersonalDMSData.length > 0) {
            ...
            for (var j = 0; j < PersonalDMSData.length; j++) {
                ...
                if (status == "Active") {
                    ...
                    GroupLimk += '<div class="panel panel-default">' +
                        ...
                        '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/group-ico.png" alt="Group Documents">' +
            ...
            GroupLimk += '<div class="panel panel-default" id="AddNewLibBox">' +
                ...
                '<div class="d-flex align-items-center">' +
                '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/add-group.png" alt="add group">' +
    ...
    for (var i = 0; i < data.length; i++) {
        if (jQuery.inArray(data[i].UserEmail.toLowerCase(), arrEmps) == '-1') {
            ...
            Divrow += '<div class="member-status-image-box">' +
                '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/' + data[i].PermissionImage + '.png" alt="">' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                if (valuesArray[proc].Contributors.results != null) {
                    for (var pplIndex = 0; pplIndex < valuesArray[proc].Contributors.results.length; pplIndex++) {
                        ...
                        if (valuesArray[proc].WebPartName == "Head of the department") {
                           ...
                           '</select>';
                           Divrow += '<div class="member-status-image-box">' +
                            '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/Full-control-m.png" alt="">' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                           ...
                           '</select>';
                           Divrow += '<div class="member-status-image-box">' +
                            '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/Contributor-m.png" alt="">' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
                            '</div>' +
        ...
        if (valuesArray.length > 0) {
            for (var proc= 0; proc< valuesArray.length; proc++) {
                if (jQuery.inArray(valuesArray[proc].LogonName.EMail.toLowerCase(), arrEmps) == '-1') {
                    ...
                    '</select>';
                    Divrow += '<div class="member-status-image-box">' +
                        '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/Reader-m.png" alt="">' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
...
function genrateHtmlgrid(Icon, ColumnCount, files, rowCount, Type, MethodAction) {
    ...
    if (files.ListItemAllFields != undefined) {
        if(files.ListItemAllFields.Titan_Permission != undefined) {
            PermissionHisHTML = '<div class="clsPermHis" onclick="ShowPermissionHistory(\'' + files.ServerRelativeUrl + '\', \'' + Type + '\');"><img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/user_permission.png" alt="#"></div>';
        }
    ...
    var tr = $('<tr>' +
        ...
        '<img width="30px" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/' + Icon + '" alt="' + Icon + '">' + checkOutHTML + 
        '</label>' +
        '</div>' +
        '</td>');
            ...
            if (files.ListItemAllFields == undefined && IsMyfavorate == true) {
                ...
                if (files.ApprovalStatus == "Approved") {
                    cell = $('<td class="text-left">' + 
                        ...
                        '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-4.png" alt="" data-themekey="#">' +
                        DateHTML + '</div>' +
                        //'<div class="dms-table-ellipsis-2">' + files.ListItemAllFields[ColumnCount[j].ColumnName] + '</div>' +
                        '</td>');
                    ...
                    cell = $('<td class="text-left">' +
                        ...
                        DateHTML + '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-5.png" alt="" data-themekey="#"></div>' +
                        //'<div class="dms-table-ellipsis-2">' + files.ListItemAllFields[ColumnCount[j].ColumnName] + '</div>' +
                        '</td>');
                    ...
                    cell = $('<td class="text-left">' +
                        ...
                        '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-3.png" alt="" data-themekey="#"></div>' +
                        //'<div class="dms-table-ellipsis-2">' + files.ListItemAllFields[ColumnCount[j].ColumnName] + '</div>' +
                        '</td>');
                } else {
                    cell = $('<td>' +
                ...
                if (files.ListItemAllFields[ApprovedById] == "Approved") {
                    ...
                    cell = $('<td class="text-left">' +
                        ...
                        '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-5.png" alt="" data-themekey="#">' +
                        DateHTML + '</div>' +
                        //'<div class="dms-table-ellipsis-2">' + files.ListItemAllFields[ColumnCount[j].ColumnName] + '</div>' +
                        '</td>');
                } else {
            ...
            if (files.ListItemAllFields == undefined && IsMyfavorate == true) {
                if (files.SharedId != null && files.SharedId != "null") {
                    if (files.SharedId == null && files.AccessLevel == "Everyone") {
                        ...
                        if (files.AccessLevel == "Everyone") {
                            EveryonceHTML = '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/globe.png" style="width:20px; margin:0 2px;">';
                        }
                        else if(files.AccessLevel == "Revoked"){
                            EveryonceHTML = '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/Everyone_Revoked.png" style="width:20px; margin:0 2px;">';
                        }
                        cell = $('<td class="text-left">' +
                            ...
                            '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/shared.png" style="width:20px; margin:0 2px;" onclick="GetSharedHistory(\'' + files.DocId + '\', \'' + files.ServerRelativeUrl + '\', \'' + FileTitle + '\', \'' + FileRef + '\', \'' + files.Name + '\', \'' + Type + '\', \'' + HistoryAction + '\', \'' + currentSharedItemId + '\')">' + EveryonceHTML + '</div>' +
                            '</td>');
                    }
                } 
                else {
                    ...
                    if(files.SecurityLevel == "Revoked"){
                        EveryonceHTML += '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/no_shared.png" style="width:20px; margin:0 2px;" onclick="GetSharedHistory(\'' + files.DocId + '\', \'' + files.ServerRelativeUrl + '\', \'' + FileTitle + '\', \'' + FileRef + '\', \'' + files.Name + '\', \'' + Type + '\', \'' + HistoryAction + '\', \'' + currentSharedItemId + '\')">';
                    }
                ...
                if (files.ListItemAllFields.SharedId == null && files.ListItemAllFields.AccessLevel == "Everyone") {
                    ...
                    cell = $('<td class="text-left">' +
                        ...
                        '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/shared.png" style="width:20px; margin:0 2px;" onclick="GetSharedHistory(\'' + DocumentId + '\', \'' + files.ServerRelativeUrl + '\', \'' + FileTitle + '\', \'' + FileRef + '\', \'' + files.Name + '\', \'' + Type + '\', \'' + HistoryAction + '\', \'' + currentSharedItemId + '\')">' + EveryonceHTML + '</div>' +
                        '</td>');
                }
            } else {
                if (files.ListItemAllFields.AccessLevel == "Everyone") {
                ...
                if(files.ListItemAllFields.SecurityLevel == "Revoked"){
                    EveryonceHTML += '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/DMS/assets/images/no_shared.png" style="width:20px; margin:0 2px;" onclick="GetSharedHistory(\'' + DocumentId + '\', \'' + files.ServerRelativeUrl + '\', \'' + FileTitle + '\', \'' + FileRef + '\', \'' + files.Name + '\', \'' + Type + '\', \'' + HistoryAction + '\', \'' + currentSharedItemId + '\')">';
                }
                cell = $('<td class="text-left">' + EveryonceHTML +
                    '</td>');
            }
                ...
                if (files.ListItemAllFields[ColumnCount[j].ColumnName] != undefined) {
                    ...
                    if (files.ListItemAllFields[ColumnCount[j].ColumnName] == "Approved") {
                        cell = $('<td class="text-left">' +
                            ...
                            '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-4.png" alt="" data-themekey="#" data-target="#approverssec" data-toggle="modal" onclick="OpenApprovalHistry(' + files.ListItemAllFields.ID + ', \'' + files.Name + '\');">' +
                            DateHTML + '</div>' +
                            //'<div class="dms-table-ellipsis-2">' + files.ListItemAllFields[ColumnCount[j].ColumnName] + '</div>' +
                            '</td>');
                        ...
                        cell = $('<td class="text-left">' +
                            ...
                            '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-5.png" alt="" data-themekey="#" data-target="#approverssec" data-toggle="modal" onclick="OpenApprovalHistry(' + files.ListItemAllFields.ID + ', \'' + files.Name + '\');">' +
                            DateHTML + '</div>' +
                            '</td>');
                        ...
                        cell = $('<td class="text-left">' +
                            ...
                            '<img style="height:17px;" src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyDocuments/AdvanceDocumentSearch/assets/images/time-icon-3.png" alt="" data-themekey="#" data-target="#approverssec" data-toggle="modal" onclick="OpenApprovalHistry(' + files.ListItemAllFields.ID + ', \'' + files.Name + '\');">' +
                            DateHTML + '</div>' +
                            '</td>')
                    } else {
