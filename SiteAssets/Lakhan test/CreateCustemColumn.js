   ...
   if(ListName=='/'){
    ...
    for(var i=0;i<arrMeta.length;i++){
      ...
      if(arrMeta[i].Title=='ApprovedDate'){ 
                 ownURL=SiteURl.split(ListName)[0]+ "/_api/web/lists/getByTitle('"+ListName+"')/fields"                
                 Metadata={__metadata:{'type': 'SP.FieldDateTime'},
                 'FieldTypeKind':arrMeta[i].FieldTypeKind,
                 'Title':arrMeta[i].Title,
                 'DisplayFormat': 0
                 //'DateOnly':0         
        ...
        ({
            ...
            success: function (data, status, xhr) {
                ...
                for (var i = 0; i < dataresults.length; i++) {
                    ...
                    DeleteListColumn(siteURL[0],ColumnTitle,ListName);
...
//Priyanshu Pandey - 20, Feb 2021 --------------------Starts
...
//Priyanshu Pandey - 20, Feb 2021 --------------------Ends