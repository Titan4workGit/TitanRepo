    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            leftPanel: function (element) {
                /* Left panel */
                var ganttLeftPanel = $('<div class="leftPanel" style="width:307px;"/>')
            ...
            createProgressBar: function (label, desc, classNames, dataObj) {
                ...
                if(dataObj[1] != undefined) {
	                if(isNaN(dataObj[1]) == true) {
	                	dataObj[1] = '0';
	                }
	            }
	            
                var CompletionWidth = dataObj[1] + "%";
                var CompletionColor = classNames.replace("Border", "");
                if(dataObj[2] == "Completed"){
                	var bar = $('<div class="bar" id="'+dataObj[3]+'"><div  id="'+dataObj[3]+'"class="progressCompl '+CompletionColor+'" style="margin:-2px 3px 3px -0;width:'+CompletionWidth+'"><div class="fn-label" id="'+dataObj[3]+'">' + label + '</div></div></div>')
                        .data("dataObj", dataObj);
                }
                else {
                	var bar = $('<div class="bar" id="'+dataObj[3]+'"><div id="'+dataObj[3]+'" class="progressCompl '+CompletionColor+'" style="margin:-2px 3px 3px -2px;width:'+CompletionWidth+'"><div class="fn-label" id="'+dataObj[3]+'">' + label + '</div></div></div>')
                        .data("dataObj", dataObj);
                }
                if (desc) {
                    bar
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            if ($l.length) {
                                ...
                                if(_bar[0].id.includes("(Overdue)") == true){
                                	$l.css("color", 'rgb(255,0,0) !important');
                                }
                                else {
                                	$l.css("color", gray);
                                	$l.css("color", 'black !important');
                                }
                            }
                        });
