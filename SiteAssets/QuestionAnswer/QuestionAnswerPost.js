            ...
            employeePicURL = "";
           	if (items.length > 0)
          	{
          	    ...
          	    userOfficeLocation=items[0].OfficeLocation.Title;
           		...
           		{
           			employeePicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[0].LogonName.EMail)//"../SiteAssets/QuestionAnswer/images/user_pic.jpg";
           		}
           	}
           	else
           	{
           		employeePicURL = "../SiteAssets/QuestionAnswer/images/user_pic.jpg";
           	}
		}, 
        error: function (data)
        {
    ...
    success: function (data) 
    {
        ...
        if (items.length > 0)
        {
         	if(items[0].AttachmentFiles.results.length>0)
           	...
           	{
           		PostEmpPicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[0].LogonName.EMail)//"../SiteAssets/QuestionAnswer/images/user_pic.jpg";
           	}
		}
        else
        {
           	PostEmpPicURL = "../SiteAssets/QuestionAnswer/images/user_pic.jpg";
        }           
	}, 
    error: function (data)
    {
