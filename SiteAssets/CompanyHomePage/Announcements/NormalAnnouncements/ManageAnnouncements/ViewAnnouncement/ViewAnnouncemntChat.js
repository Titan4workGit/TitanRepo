...
function getAnnLikedUsers() {
    ...
    if(QueryResult.length>0){
        //$('#like-Img-color-Anncmnt').attr('src', "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/Experience/assets/images/like-icon-fill.png");
        for(var i=0; i<QueryResult.length; i++)
        {
        ...
        $('#like-Img-color-Anncmnt').attr('src', "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/Experience/assets/images/like-icon.png");
        Html_Design = Html_Design + "<li class='likes-box'>" +
                                           "<div class='comment-reply-user-name' style='width:212px !important;border-radius:3% !important'>"+
...
{	
    ...
    if($(".like-img-Ann").attr("src") == "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/Experience/assets/images/like-icon.png"){
        $('#like-Img-color-Anncmnt').attr('src', "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/Experience/assets/images/like-icon-fill.png");
