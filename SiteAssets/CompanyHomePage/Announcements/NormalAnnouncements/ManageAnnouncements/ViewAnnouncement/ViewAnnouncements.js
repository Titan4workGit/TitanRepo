    ...
    if (Announecemnts.length > 0) {
        for (var i = 0; i < Announecemnts.length; i++) {
            ...
            if (Announecemnts[i].Author.EMail == _spPageContextInfo.userEmail) {
                ...
                AlertAnnouncment += '<img src="../SiteAssets/CompanyHomePage/Announcements/NormalAnnouncements/ManageAnnouncements/ViewAnnouncement/assets/images/more-horiz.png"></button>';
