...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			var container = $('<div/>',{'class':"tabbable tabs-left col-md-12"});
			var navTabs = $('<ul/>',
									{ class: "nav nav-tabs shadow3"
							}).append($('<li/>',
										{ class:"active"
									}).append($('<a/>',{
			...
			var getURL = $("<button/>",{
				class:"btn btn-outline-success go-btn",
				type:"button"
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_img'	: { "modal": false,// change by lakhan
			...
			var settings = $.extend({				
				...
				'insert_link':true,
				'unlink':true,
				'insert_img':false,//hide by lakhan 
				'hr_line':true,
				'block_quote':true,
				'source':true,
				'strikeout':true,
								              ...
								              "aria-hidden":"true"
								            	...
								            	class:"modal-dialog"
							            			...
							            			class:"modal-content"
									           			...
									           			class:"modal-header panel-head-4"
									           			}).append($('<button/>',{
										                	type:"button",
