               ...
               ImageCount=files.length;
	            ...
	            if(thumbNailUrl=="")
	            {
	              ...
	              if(folderName.length>29)
	              {
		           ...
		           menuFolderHTML +='<img class="album-count-box-icon" src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/album-icon.png" alt="album icon">';
		           ...
		           menuFolderHTML +='<img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/MediaGallery/assets/images/more-horiz.png">';
