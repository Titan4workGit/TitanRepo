                ...
                if (items.length > 0) {
                    if (items[0].AttachmentFiles.results.length > 0) {
                    	...
                    	if(items[0].Email != null && items[0].Email != "null" && items[0].Email != ""){
                        	employeePicURL = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[0].Email)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                    	}
                    	else {
            ...
            if (items.length > 0) {
                if (EmpID == undefined || EmpID == null) {
                    ...
                    if (items[0].AttachmentFiles.results.length > 0) {
                        ...
                        LoginUserImage = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[0].Email)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                    }
                    ...
                    if (items[0].AttachmentFiles.results.length > 0) {
                        ...
                        CommentUserImage = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(items[0].Email)//"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
                    }
                }
            }
        },
