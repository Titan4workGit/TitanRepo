...
function ApplicationLink()
{
	...
	$.ajax({  
		...
		{ 
			...
			{
				$('#H_learning').append('<div class="item active Null-Case-learning"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@tree/main/ImageGallery/Default_Learning.png" alt="" class="LearningNull"></div>');
