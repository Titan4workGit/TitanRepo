  ...
  //var Ownurl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('ApplicationLink')/items?select=*,AttachmentFiles&$expand=AttachmentFiles&$filter=Company eq '2' and Status eq '1' and VisibleAt eq 'Home Page'&$Top=6&$orderby=Modified desc";  
	$.ajax({  
		...
		{ 
			...
			/*	for(k=0; k<8; k++)
				{
					if(k==0){ $('#H_learning').append('<div class="item active"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/images/i1.jpeg" id="sliderImage'+k+'"  alt=""><h5 class="event-text-head-new">Launch of Intranet Portal at new office location</h5></div>'); }
					else { $('#H_learning').append('<div class="item"><img src="https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo@main/SiteAssets/Biography/images/i2.jpg" id="sliderImage'+k+'"  alt=""><h5 class="event-text-head-new">Launch of Intranet Portal at new office location</h5></div>'); }				
				}
