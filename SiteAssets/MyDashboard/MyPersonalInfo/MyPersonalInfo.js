...
function GetFavourites() {
    ...
    $.when(CommonFunction.getItemsWithQueryItem("MyFavorites", RestQuery)).done(function (MyFavorites) {
        ...
        for(var fav=0;fav<arrFavTasks.length; fav++) {
	        ...
	        TaskHTML += '<img src="https://github.com/Titan4workGit/TitanRepo/tree/main/SiteAssets/MyFavorite/Images/my-fav-menu-vertical.png" alt="menu vertical"></button><ul class="dropdown-menu dropdown-menu-right">';
