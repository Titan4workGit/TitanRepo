...
function timeSheetEntry(taskid) {
    ...
    var txtCompanyId = Logged_CompanyId;
    if (IsModal == "true") {
        var url = _spPageContextInfo.webAbsoluteUrl + "/Pages/TimeSheetEntry.aspx?WebAppId=" + txtCompanyId + "&TaskId=" + window.btoa(taskid) + "&Mode=" + window.btoa('Add') + "&IsModal=dHJ1ZQ==&sourceLocation=TaskDetails";
    }
    else {
        var url = _spPageContextInfo.webAbsoluteUrl + "/Pages/TimeSheetEntry.aspx?WebAppId=" + txtCompanyId + "&TaskId=" + window.btoa(taskid) + "&Mode=" + window.btoa('Add') + "&sourcelocation=../Pages/timesheet.aspx";
    }
